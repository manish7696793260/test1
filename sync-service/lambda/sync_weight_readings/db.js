...
const buildOCMAppItem = (userID, item, app, date) => {
	item.userId_type_deviceLocalName = `${userID}_weight_Manual`;
	return {
		PutRequest: {
			Item: {
				userId_type_deviceLocalName: `${userID}_weight_Manual`,
 ...
 */
const saveReadings = async (app, userID, array, table, date) => {
...
exports.saveReadings = saveReadings;
