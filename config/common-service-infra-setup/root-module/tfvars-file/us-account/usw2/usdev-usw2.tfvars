...
non_prd_env = "usnp"
country_environment = "usdev"                                          #  Update required
...
default_additional_tags = {
  ...
  "ohi:environment" = "usdev-usw2",                                     #  Update required
  "ohi:stack-name"  = "usdev-usw2-common-tf-initial-setup-pipeline"     #  Update required
  }
...
public_subnets    = []
private_subnets =["10.0.121.0/27","10.0.121.32/27"]                        #  Update required
public_subnet_names = []
...
iam_policy_config = {
  ...
  auth-policy7 = {
    ...
    iam_policy_template_path = "./../resource-policy-template/iam-policy-permission-template/common-auth-service-lambda-role/cognito.tpl"
     template_variable = {
      cognito="us-west-2_sTkyhQSR3"                                                           #  Update required
     }
     tag="auth_additional_tags"
    },
  be-policy1 = {
...
security_groups = [
  {
    ...
    egress_rules = [
  {
    description = "dev-ofs-user-report"              #  Update required
    from_port   = 6061
    to_port     = 6061
    protocol    = "tcp"
