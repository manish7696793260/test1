...
non_prd_env = "usnp"
country_environment = "usstg"                                          #  Update required
...
default_additional_tags = {
  ...
  "ohi:environment" = "usstg-usw2",                                     #  Update required
  "ohi:stack-name"  = "usstg-usw2-common-tf-initial-setup-pipeline"     #  Update required
  }
...
existing_waf_name="usnp-euw1-common-cdn-waf-acl"                                                       #  Update required
scope="CLOUDFRONT"
...
cloudfront_config = {
  "common-s3" = {
    ...
    acm_certificate_domain = "stg.us.ohiomron.com"                                      #  Update required
    existing_domain_name  = "stg.us.ohiomron.com"                   #  Update required
    subdomain_name = "common-terms-cdn.stg.us.ohiomron.com"                #  Update required
...
iam_policy_config = {
  ...
  auth-policy7 = {
    ...
    iam_policy_template_path = "./../resource-policy-template/iam-policy-permission-template/common-auth-service-lambda-role/cognito.tpl"
     template_variable = {
      cognito="us-west-2_mkXRIn5uQ"                                                           #  Update required
     }
     tag="auth_additional_tags"
    },
  be-policy1 = {
...
security_groups = [
    ...
    egress_rules = [
  {
    ...
    to_port     = 6062
    protocol    = "tcp"
    security_groups = ["stg-ofs-user-report"]         #  Update required
    ipv6_cidr_blocks  = []
    prefix_list_ids   = []
    cidr_blocks = []
  },
