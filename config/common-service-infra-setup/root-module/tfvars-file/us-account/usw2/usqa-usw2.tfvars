...
environment = "qa"                                                    #  Update required
non_prd_env = "usnp"
country_environment = "usqa"                                          #  Update required
...
default_additional_tags = {
  ...
  "ohi:environment" = "usqa-usw2",                                     #  Update required
  "ohi:stack-name"  = "usqa-usw2-common-tf-initial-setup-pipeline"     #  Update required
  }
...
cloudfront_config = {
  "common-s3" = {
    ...
    acm_certificate_domain = "qa.us.ohiomron.com"                                      #  Update required
    existing_domain_name  = "qa.us.ohiomron.com"                   #  Update required
    subdomain_name = "common-terms-cdn.qa.us.ohiomron.com"                #  Update required
...
iam_policy_config = {
  ...
  auth-policy7 = {
    ...
    iam_policy_template_path = "./../resource-policy-template/iam-policy-permission-template/common-auth-service-lambda-role/cognito.tpl"
     template_variable = {
      cognito="us-west-2_Z9hDiFAj4"                                                           #  Update required
     }
     tag="auth_additional_tags"
    },
  be-policy1 = {
...
security_groups = [
  {
    ...
    egress_rules = [
  {
    description = "usdev-ofs-user-report"              #  Update required
    from_port   = 6061
    to_port     = 6061
    protocol    = "tcp"
    security_groups = ["sg-002ee33768bfbdeaa"]         #  Update required
    ipv6_cidr_blocks  = []
    prefix_list_ids   = []
    cidr_blocks = []
  },
