...
environment = "beta"                                                    #  Update required
non_prd_env = "usnp"
country_environment = "usbeta"                                          #  Update required
...
default_additional_tags = {
  ...
  "ohi:environment" = "usbeta-usw2",                                     #  Update required
  "ohi:stack-name"  = "usbeta-usw2-common-tf-initial-setup-pipeline"     #  Update required
  }
...
existing_waf_name="usnp-usw2-common-cdn-waf-acl"                                                       #  Update required
scope="CLOUDFRONT"
...
existing_s3_gateway_endpoint_id = "vpce-0e886ab9bfcb90a60"
existing_dynamodb_gateway_endpoint_id =  "vpce-0dd0d7a330a8dbe1d"
vpc_name= "vlt"
cidr_block  = "10.0.0.0/16"                                                #  Update required
public_subnets    = []
private_subnets =["10.0.124.0/27","10.0.124.32/27"]                        #  Update required
public_subnet_names = []
...
cloudfront_config = {
  "common-s3" = {
    ...
    acm_certificate_domain = "beta.us.ohiomron.com"                                      #  Update required
    existing_domain_name  = "beta.us.ohiomron.com"                   #  Update required
    subdomain_name = "common-terms-cdn.beta.us.ohiomron.com"                #  Update required
...
iam_policy_config = {
  ...
  auth-policy7 = {
    ...
    iam_policy_template_path = "./../resource-policy-template/iam-policy-permission-template/common-auth-service-lambda-role/cognito.tpl"
     template_variable = {
      cognito="us-west-2_9LpftPeY0"                                                           #  Update required
     }
    tag="auth_additional_tags"
    },
  be-policy1 = {
...
security_groups = [
  {
    ...
    egress_rules = [
  {
    description = "usstg-ofs-user-report"              #  Update required
    from_port   = 6062
    to_port     = 6062
    protocol    = "tcp"
    security_groups = ["sg-0cbcae5638a314552"]         #  Update required
    ipv6_cidr_blocks  = []
    prefix_list_ids   = []
    cidr_blocks = []
  },
