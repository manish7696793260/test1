...
non_prd_env = "eunp"
country_environment = "eubeta"                                          #  Update required
...
default_additional_tags = {
  ...
  "ohi:environment" = "eubeta-euw1",                                                                   #  Update required
  "ohi:stack-name"  = "eubeta-euw1-common-tf-initial-setup-pipeline"       #  Update required
  }
default_non_prd_additional_tags= {
  ...
  "ohi:stack-name"  = "eubeta-euw1-common-tf-initial-setup-pipeline"  
  }
...
existing_waf_name="eunp-euw1-common-cdn-waf-acl"                                                   #  Update required
scope="CLOUDFRONT"
...
existing_dynamodb_gateway_endpoint_id =  "vpce-077c473414eb290fb"  
vpc_name= "vlt"
cidr_block  = "10.18.0.0/16"                                                #  Update required
public_subnets    = []
private_subnets =["10.18.24.0/27","10.18.24.32/27"]                        #  Update required
public_subnet_names = []
...
cloudfront_config = {
  "common-s3" = {
    ...
    acm_certificate_domain = "beta.eu.ohiomron.eu"                  #  Update required
    existing_domain_name  = "beta.eu.ohiomron.eu"                   #  Update required
    subdomain_name = "common-terms-cdn.beta.eu.ohiomron.eu"         #  Update required
...
iam_policy_config = {
  ...
  auth-policy7 = {
    ...
    iam_policy_template_path = "./../resource-policy-template/iam-policy-permission-template/common-auth-service-lambda-role/cognito.tpl"
     template_variable = {
      cognito="eu-west-1_VJwCc3fhV"                                                           #  Update required
     }
     tag="auth_additional_tags"
    },
  be-policy1 = {
...
security_groups = [
  {
    ...
    egress_rules = [
      {
        description = "eustg-euw1-vlt-ofs-report-ec2"                         
        from_port   = 6062
        to_port     = 6062
        protocol    = "tcp"
        security_groups = ["sg-06e37e7f00e03f63d"]
        ipv6_cidr_blocks  = []
        prefix_list_ids   = []
        cidr_blocks = []
      },
