...
non_prd_env = "eunp"
country_environment = "euprd"                                          #  Update required
...
default_additional_tags = {
  ...
  "ohi:environment" = "euprd-euw1",                                                                   #  Update required
  "ohi:stack-name"  = "euprd-euw1-common-tf-initial-setup-pipeline"       #  Update required
  }
default_non_prd_additional_tags= {
  ...
  "ohi:stack-name"  = "euprd-euw1-common-tf-initial-setup-pipeline"  
  }
...
cloudfront_config = {
  "common-s3" = {
    ...
    acm_certificate_domain = "prd.eu.ohiomron.eu"                  #  Update required
    existing_domain_name  = "prd.eu.ohiomron.eu"                   #  Update required
    subdomain_name = "common-terms-cdn.prd.eu.ohiomron.eu"         #  Update required
...
security_groups = [
  {
    ...
    egress_rules = [
      {
        description = "euprd-ofs-user-report"                         
        from_port   = 7071
        to_port     = 7071
        protocol    = "tcp"
       ...
       {
        description = "euprd-ofs-user-report"              #  Update required
        from_port   = 6061
        to_port     = 6061
        protocol    = "tcp"
        ipv6_cidr_blocks  = []
