...
non_prd_env = "eunp"
country_environment = "euqa"                                          #  Update required
...
default_additional_tags = {
  ...
  "ohi:environment" = "euqa-euw1",                                                                   #  Update required
  "ohi:stack-name"  = "euqa-euw1-common-tf-initial-setup-pipeline"       #  Update required
  }
default_non_prd_additional_tags= {
  ...
  "ohi:stack-name"  = "euqa-euw1-common-tf-initial-setup-pipeline"  
  }
...
cloudfront_config = {
  "common-s3" = {
    ...
    acm_certificate_domain = "qa.eu.ohiomron.eu"                  #  Update required
    existing_domain_name  = "qa.eu.ohiomron.eu"                   #  Update required
    subdomain_name = "common-terms-cdn.qa.eu.ohiomron.eu"         #  Update required
...
iam_policy_config = {
  ...
  auth-policy7 = {
    ...
    iam_policy_template_path = "./../resource-policy-template/iam-policy-permission-template/common-auth-service-lambda-role/cognito.tpl"
     template_variable = {
      cognito="eu-west-1_liLd4C9AS"                                                           #  Update required
     }
     tag="auth_additional_tags"
    },
  be-policy1 = {
...
security_groups = [
  {
    ...
    egress_rules = [
      {
        description = "eudev-ofs-user-report"              #  Update required
        from_port   = 7072
        to_port     = 7072
        protocol    = "tcp"
        ipv6_cidr_blocks  = []
